...
//words
var AllChoices = [["10%", "20%", "30%", "40%"], ["20%", "10%", "30%", "40%"], ["30%", "20%", "10%", "40%"], ["40%", "20%", "10%", "30%"], ["50%", "60%", "70%", "80%"], ["60%", "70%", "80%", "50%"], ["70%", "60%", "80%", "50%"], ["80%", "70%", "60%", "50%"], ["90%", "70%", "80%", "100%"], ["100%", "70%", "80%", "90%"], ["20%", "40%", "60%", "80%"],["40%", "20%", "60%", "80%"], ["60%", "40%", "20%", "80%"], ["80%", "40%", "20%", "80%"], ["100%", "40%", "60%", "80%"], ["0%","15%","83%", "1%"],["0%","15%","83%", "1%"], ["50%", "60%", "70%", "80%"], ["50%", "60%", "70%", "80%"], ["50%", "60%", "70%", "80%"], ["50%", "60%", "70%", "80%"], ["25%", "75%", "50%", "100%"], ["50%", "75%", "25%", "100%"], ["75%", "50%", "25%", "100%"], ["100%", "75%", "50%", "25%"], ["33%", "67%", "25%", "100%"], ["67%", "33%", "100%", "25%"],["100%", "33%", "67%", "25%"]];
//definitions
...
function OnGUI(){
	...
	if(wrongDelay != 0){
		...
		wrongDelay -=1;
     	...
     	//Question
     	GUI.Label (Rect (660, 200, 1500, 300), Questions[currentQuestion], labStyle);
